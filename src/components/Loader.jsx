...
const Loader = ({ contained = false, label = "Loading" }) => {
  return (
    <div
      className={`${
        contained ? "absolute inset-0 z-20" : "fixed inset-0 z-[150]"
      } flex items-center justify-center bg-[#050508]/70 backdrop-blur-sm`}
    >
